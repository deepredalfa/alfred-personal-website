...
const TECH_CATEGORIES = [
  ...
  },
  {
    ...
    icon: Layers,
    accent: 'sky',
    skills: ['Azure Databricks (Delta Lake, Unity Catalog, Workflows/Jobs, Photon)', 'Apache Spark', 'PySpark', 'Azure HDInsight'],
  },
  {
    id: 'modeling',
    label: 'Data Modeling',
  ...
  },
  {
    ...
    icon: Server,
    accent: 'amber',
    skills: ['Delta Lake', 'Parquet', 'Avro', 'JSON', 'XML'],
  },
  {
    id: 'cloud',
    label: 'Cloud (Azure)',
    icon: Cloud,
    accent: 'blue',
    skills: ['Azure Key Vault', 'ADLS Gen2', 'Entra ID', 'Azure Data Factory', 'Azure SQL Data Warehouse (Gen2)', 'Azure DevOps'],
  },
  {
    id: 'orchestration',
    ...
    icon: Workflow,
    accent: 'cyan',
    skills: ['Airflow', 'Azure DevOps', 'Jenkins', 'Terraform', 'Git'],
  },
  {
    id: 'streaming',
    ...
    icon: Activity,
    accent: 'rose',
    skills: ['Apache Kafka', 'Azure Event Hubs'],
  },
  {
    id: 'governance',
    ...
    icon: Shield,
    accent: 'green',
    skills: ['Unity Catalog', 'Data Quality Practices', 'DBT', 'SLA Adherence', 'Production Incident Management'],
  },
  {
    id: 'integration',
    label: 'Integration',
    icon: Network,
    accent: 'indigo',
    skills: ['Mule ESB', 'Spring Boot', 'REST APIs', 'OAuth/OIDC', 'Event-Driven Architectures'],
  },
  {
    id: 'databases',
    label: 'Databases',
  ...
  },
  {
    ...
    icon: Users,
    accent: 'teal',
    skills: ['Cross-functional Stakeholder Alignment', 'Technical Mentorship', 'Agile/Scrum Delivery (Jira/Confluence)'],
  },
]
