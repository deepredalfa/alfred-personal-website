  ...
  theme: {
    extend: {
      ...
      animation: {
        ...
        'aurora-1':  'aurora-1 5s ease-in-out infinite',
        'aurora-2':  'aurora-2 7s ease-in-out infinite',
        'aurora-3':  'aurora-3 4s ease-in-out infinite',
        'aurora-4':  'aurora-4 6s ease-in-out infinite',
      },
    },
  },
  plugins: [],
